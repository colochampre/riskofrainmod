...
public class ItemInit {
        ...
        public static final RegistryObject<Item> LEMURIAN_SPAWN_EGG = ITEMS.register("lemurian_spawn_egg",
                        () -> new ForgeSpawnEggItem(EntityInit.LEMURIAN_ENTITY, 0x6C537B, 0x2E2242, props()));
        public static final RegistryObject<Item> STONE_GOLEM_SPAWN_EGG = ITEMS.register(
                        "stone_golem_spawn_egg",
        ...
        public static final RegistryObject<Item> GUNNER_DRONE_SPAWN_EGG = ITEMS.register(
                        "gunner_drone_spawn_egg",
                        () -> new ForgeSpawnEggItem(EntityInit.GUNNER_DRONE_ENTITY, 0x007ADA, 0x202F51, props()));
        public static final RegistryObject<Item> GUNNER_TURRET_SPAWN_EGG = ITEMS.register(
                        "gunner_turret_spawn_egg",
        ...
        public static final RegistryObject<Item> GUNNER_TURRET_ITEM_GRAY = ITEMS.register("gunner_turret_gray",
                        () -> new GunnerTurretItem(props().stacksTo(16)));
        public static final RegistryObject<Item> GUNNER_TURRET_ITEM_LIGHT_GRAY = ITEMS.register(
                        "gunner_turret_light_gray",
                        () -> new GunnerTurretItem(props().stacksTo(16)));
