...
public class BeetleAttackGoal extends Goal {

  protected final BeetleEntity mob;
  ...
  public BeetleAttackGoal(BeetleEntity entity, double speedModifier, boolean useMemory) {
    this.mob = entity;
    this.speedModifier = speedModifier;
    this.followingTargetEvenIfNotSeen = useMemory;
