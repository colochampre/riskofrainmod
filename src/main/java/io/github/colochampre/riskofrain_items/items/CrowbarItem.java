...
public class CrowbarItem extends Item {
  ...
  public void appendHoverText(ItemStack itemstack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
    tooltip.add(Component.translatable("item.riskofrain_items.crowbar.tooltip_1"));
    tooltip.add(Component.translatable("item.riskofrain_items.crowbar.tooltip_2"));
    tooltip.add(Component.translatable("item.riskofrain_items.crowbar.tooltip_3"));
