...
public class LootInit {
  ...
  public static final RegistryObject<Codec<? extends IGlobalLootModifier>> ADD_COMMON_LOOT =
          LOOT_MODIFIER_SERIALIZERS.register("add_common_loot_table", CommonLootTableModifier.CODEC);
  public static final RegistryObject<Codec<? extends IGlobalLootModifier>> ADD_UNCOMMON_LOOT =
          LOOT_MODIFIER_SERIALIZERS.register("add_uncommon_loot_table", UncommonLootTableModifier.CODEC);
  /*
