...
public class CommonLootTableModifier extends LootModifier {
  ...
  public static final Supplier<MapCodec<CommonLootTableModifier>> CODEC = Suppliers.memoize(() ->
          RecordCodecBuilder.mapCodec(inst -> codecStart(inst).apply(inst, CommonLootTableModifier::new)));
  ...
  public CommonLootTableModifier(LootItemCondition[] conditionsIn) {
    super(conditionsIn);
